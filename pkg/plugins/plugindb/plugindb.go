...
func Open(srv v1.StorageQuerierPlugin_InjectQuerierServer) storage.MeshStorage {
	return &pluginDB{srv: srv}
}

type pluginDB struct {
	srv v1.StorageQuerierPlugin_InjectQuerierServer
...
func (p *pluginDB) Subscribe(ctx context.Context, prefix []byte, fn storage.KVSubscribeFunc) (context.CancelFunc, error) {
