          ...
          <q-td>
            <q-list style="max-width: 50%">
              <q-item
                dense
                :key="idx"
                v-for="(rule, idx) in props.row.getRulesList()"
              >
                <q-item-section>
                  ...
                  <q-list>
                    <q-item
                      dense
                      v-for="(resource, idx) in resourceStrings(
                        rule.getResourcesList()
                      )"
                      :key="idx"
                    >
                ...
                <q-item-section>
                  ...
                  <q-list>
                    <q-item
                      dense
                      v-for="(verb, idx) in verbStrings(rule.getVerbsList())"
                      :key="idx"
                    >
